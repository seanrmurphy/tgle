...
`tg-le` - a Telegram link extractor.
...
`tg-le` works with the [Telegram API](https://core.telegram.org/#api-methods) using the [`gotd/td``](https://github.com/gotd/td) library.
